...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'coalheartcache_story', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['coalheartcache.Category']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Story.category'
        db.delete_column(u'coalheartcache_story', 'category_id')
