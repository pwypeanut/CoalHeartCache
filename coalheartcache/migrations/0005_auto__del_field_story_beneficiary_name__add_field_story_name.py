...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Story.beneficiary_name'
        db.delete_column(u'coalheartcache_story', 'beneficiary_name')

        # Adding field 'Story.name'
        db.add_column(u'coalheartcache_story', 'name',
                      self.gf('django.db.models.fields.CharField')(default='Bobby', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Story.beneficiary_name'
        db.add_column(u'coalheartcache_story', 'beneficiary_name',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=50),
                      keep_default=False)

        # Deleting field 'Story.name'
        db.delete_column(u'coalheartcache_story', 'name')
